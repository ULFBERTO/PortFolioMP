...
function ContactSection({ data }) {
  ...
  return (
    <section id="contact" className="flex flex-col gap-6 rounded-3xl bg-surface-dark p-6 md:p-10 border border-white/5 relative overflow-hidden" aria-label={contact.title[lang]}>
      <div className="absolute -right-10 -bottom-10 w-48 h-48 bg-primary/5 rounded-full blur-3xl pointer-events-none" aria-hidden />

      <div className="flex flex-col md:flex-row gap-8 items-start md:items-center justify-between relative z-10">
        <div className="flex flex-col gap-4 max-w-xl">
          <div className="flex items-center gap-2">
            <span className="material-symbols-outlined text-primary" aria-hidden>handshake</span>
        ...
        <div className="flex flex-wrap gap-4">
          ...
          >
            <span>GitHub</span>
            <span className="material-symbols-outlined text-[18px]" aria-hidden>arrow_outward</span>
          </a>
          <a
